...
import { A as App, g as deserializeManifest } from './chunks/astro.eff5881d.mjs';
import 'fast-glob';
...
const _page0  = () => import('./chunks/index@_@astro.c3c3146c.mjs');const pageMap = new Map([["src/pages/index.astro", _page0]]);
const _manifest = Object.assign(deserializeManifest({"adapterName":"@astrojs/vercel/serverless","routes":[{"file":"","links":[],"scripts":[{"type":"inline","value":"let m=document.getElementById(\"nav\"),d=document.getElementById(\"open\"),r=document.getElementById(\"close\");d.addEventListener(\"click\",()=>{m.classList.add(\"activity\"),d.classList.add(\"act\"),r.classList.add(\"closeactive\"),body.classList.add(\"body\")});r.addEventListener(\"click\",()=>{m.classList.remove(\"activity\"),d.classList.remove(\"act\"),r.classList.remove(\"closeactive\")});let t=document.getElementById(\"h1\");const s=t.clientHeight,o=t.clientWidth;t.addEventListener(\"mousemove\",n=>{const{layerX:a,layerY:c}=n,i=(a-o/2)/o*20,l=`\n\t\tperspective(500px)\n\t\tscale(1.1)\n\t\trotateX(${(c-s/2)/s*20}deg)\n\t\trotateY(${i}deg)`;t.style.transform=l});t.addEventListener(\"mouseout\",()=>{t.style.transform=`\n\t\tperspective(500px)\n\t\tscale(1)\n\t\trotateX(0)\n\t\trotateY(0)`});let e=document.getElementById(\"h2\");e.clientHeight;e.clientWidth;e.addEventListener(\"mousemove\",n=>{const{layerX:a,layerY:c}=n,i=(a-o/2)/o*15,l=`\n\t   perspective(500px)\n\t   scale(1.05)\n\t   rotateX(${(c-s/2)/s*15}deg)\n\t   rotateY(${i}deg)`;e.style.transform=l});e.addEventListener(\"mouseout\",()=>{e.style.transform=`\n\t\tperspective(500px)\n\t\tscale(1)\n\t\trotateX(0)\n\t\trotateY(0)`});\n"}],"styles":[{"type":"external","src":"/_astro/index.55b198a5.css"}],"routeData":{"route":"/","type":"page","pattern":"^\\/$","segments":[],"params":[],"component":"src/pages/index.astro","pathname":"/","prerender":false,"_meta":{"trailingSlash":"ignore"}}}],"base":"/","compressHTML":false,"markdown":{"drafts":false,"syntaxHighlight":"shiki","shikiConfig":{"langs":[],"theme":"github-dark","wrap":false},"remarkPlugins":[],"rehypePlugins":[],"remarkRehype":{},"gfm":true,"smartypants":true},"componentMetadata":[["C:/Users/wilir/ ASTRO/src/pages/index.astro",{"propagation":"none","containsHead":true}]],"renderers":[],"clientDirectives":[["idle","(()=>{var i=t=>{let e=async()=>{await(await t())()};\"requestIdleCallback\"in window?window.requestIdleCallback(e):setTimeout(e,200)};(self.Astro||(self.Astro={})).idle=i;window.dispatchEvent(new Event(\"astro:idle\"));})();"],["load","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).load=e;window.dispatchEvent(new Event(\"astro:load\"));})();"],["media","(()=>{var s=(i,t)=>{let a=async()=>{await(await i())()};if(t.value){let e=matchMedia(t.value);e.matches?a():e.addEventListener(\"change\",a,{once:!0})}};(self.Astro||(self.Astro={})).media=s;window.dispatchEvent(new Event(\"astro:media\"));})();"],["only","(()=>{var e=async t=>{await(await t())()};(self.Astro||(self.Astro={})).only=e;window.dispatchEvent(new Event(\"astro:only\"));})();"],["visible","(()=>{var r=(i,c,n)=>{let s=async()=>{await(await i())()},t=new IntersectionObserver(e=>{for(let o of e)if(o.isIntersecting){t.disconnect(),s();break}});for(let e of n.children)t.observe(e)};(self.Astro||(self.Astro={})).visible=r;window.dispatchEvent(new Event(\"astro:visible\"));})();"]],"entryModules":{"\u0000@astrojs-ssr-virtual-entry":"_@astrojs-ssr-virtual-entry.mjs","\u0000@astro-renderers":"renderers.mjs","\u0000empty-middleware":"_empty-middleware.mjs","/src/pages/index.astro":"chunks/pages/index.astro.4891e3c5.mjs","\u0000@astro-page:src/pages/index@_@astro":"chunks/index@_@astro.c3c3146c.mjs","/astro/hoisted.js?q=0":"_astro/hoisted.317f3d7a.js","astro:scripts/before-hydration.js":""},"assets":["/_astro/index.55b198a5.css","/astro.webp","/favicon.svg","/svg/astro.svg","/svg/javascrt.svg","/svg/react.svg","/svg/svelte.svg","/svg/tailwind.svg","/svg/triangle.svg"]}), {
	pageMap,
	renderers,
});
